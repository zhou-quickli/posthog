...
class TestActorsQueryRunner(ClickhouseTestMixin, APIBaseTest):
    ...
    def test_last_seen_for_persons(self):
        ...
        # Should have one person with last_seen timestamp
        self.assertEqual(len(response.results), 1)
        ...
        # Should be the timestamp from the latest event (2023-05-09T14:30:00Z)
        self.assertEqual(last_seen_value, "2023-05-09 14:30:00")
